...
export default {
  ...
  props: {
    // You can add props here if you need to customize the sidebar
  },
  methods: {
    getNombreApellido() {
    ...
    getUserProfile() {
      this.perfil = localStorage.getItem('userPerfil') !== null ? parseInt(localStorage.getItem('userPerfil')) : 3
    }
  },
  created() {
